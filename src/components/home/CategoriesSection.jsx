...
//         {/* Header */}
//         <div className="flex flex-col md:flex-row md:items-center justify-between gap-0 md:gap-6 mb-6">
//           <div>
//             <RevealText>
//               <h2
//                 /////yaha se mb 2 hata de
//                 className="section-heading pb-2 mb-2"
//                 style={{ color: "#1a1410" }}
//               >
//                 Our Product{" "}
          ...
          {CATEGORIES.map((cat, i) => (
            ...
            >
              ...
              >
                ...
                <div
                  className="relative overflow-hidden"
                  style={{ aspectRatio: "4/5", background: "#ede8e2" }}
                >
                  <img
                    src={cat.image}
                    alt={cat.label}
                  ...
                  {/* hover gradient + View Details */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                    <div
                      className="absolute inset-0"
                      style={{
                        background:
                          "linear-gradient(to top, rgba(26,20,16,0.55) 0%, transparent 45%)",
                      }}
                    />
                    <span className="absolute bottom-4 left-4 font-display text-base md:text-lg text-white translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                      View Details
                    </span>
                  </div>
                ...
                {/* Title */}
                <h3
                  className="font-display text-base md:text-xl leading-snug mt-4 transition-colors duration-300 group-hover:text-[#8b1a1a]"
                  style={{ color: "#1a1410" }}
                >
                  {cat.label}
                </h3>
                ...
                {/* underline */}
                <div
                  className="h-px w-full mt-3 transition-colors duration-300"
