...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        {/* LEFT — text content (Increased lg:pl-24 and xl:pl-32 to push text right) */}
        <div
          className="flex flex-col px-6 sm:px-10 lg:pl-16 lg:pr-12 xl:pl-28 xl:pr-16 pt-6 pb-6 lg:pb-8 lg:w-1/2 xl:w-[52%]"
          style={{
        ...
        >
          ...
          <div
            ...
            className="hidden lg:block absolute inset-y-8 left-4 lg:right-16 xl:right-20 rounded-2xl overflow-hidden"
            style={{
              background: "#ede8e2",
              boxShadow:
      ...
      <div className="relative z-10 px-6 lg:mb-2 sm:px-10 lg:pl-32 lg:pr-16 xl:pl-28 xl:pr-20 -mt-2 lg:-mt-4 pb-12 lg:pb-16 w-full">
