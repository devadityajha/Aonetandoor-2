...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* Reverted to flex justify-between but with the exact Hero section width/paddings */}
        {/* <div className="max-w-[1440px] mx-auto w-full px-6 sm:px-10 lg:px-16 xl:px-20 flex items-center justify-between"> */}
        {/* <div className="max-w-[1440px] mx-auto w-full px-6 sm:px-10 lg:px-40 xl:px-45 flex items-center justify-between"> */}
        <div className="max-w-[1440px] mx-auto w-full px-6 sm:px-10 lg:px-16 xl:px-28 flex items-center justify-between">
          {/* Logo */}
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <div className="max-w-[1440px] mx-auto w-full px-6 sm:px-10 py-8 flex flex-col gap-1">
